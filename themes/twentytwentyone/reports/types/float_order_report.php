<?php
	add_shortcode('float_order_report', 'func_float_order_report');
	function func_float_order_report(){ 
		ob_start(); ?>
		<table class="float_order_reportsTable" id="float_order_reportsTable">
	        <thead>
	            <tr>
