<?php
	add_shortcode('active_product_listing_report_extract', 'func_active_product_listing_report_extract');
	function func_active_product_listing_report_extract(){ 
		ob_start(); ?>
		<table class="active_product_listing_report_extractsTable" id="active_product_listing_report_extractsTable">
	        <thead>
	            <tr>
