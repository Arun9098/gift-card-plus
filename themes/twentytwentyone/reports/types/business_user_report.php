<?php
	add_shortcode('business_user_report', 'func_business_user_report');
	function func_business_user_report(){ 
		ob_start(); ?>
		<table class="business_user_reportsTable" id="business_user_reportsTable">
	        <thead>
	            <tr>
