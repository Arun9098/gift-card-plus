<?php
	add_shortcode('float_balance_report', 'func_float_balance_report');
	function func_float_balance_report(){ 
		ob_start(); ?>
		<table class="float_balance_reportsTable" id="float_balance_reportsTable">
	        <thead>
	            <tr>
					...
					<th data-head_slug="current_float_balance">Current Float Balance</th>
