<?php
	add_shortcode('client_billing_balance_report', 'func_client_billing_balance_report');
	function func_client_billing_balance_report(){ 
		ob_start(); ?>
		<table class="client_billing_balance_reportsTable" id="client_billing_balance_reportsTable">
	        <thead>
	            <tr>
