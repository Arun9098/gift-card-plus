...
if( isset($email_templates['customer_processing_order']) 
    ...
    && isset($email_templates['customer_processing_order']['email_content']) 
    && !empty($email_templates['customer_processing_order']['email_content']) ){
	echo $email_templates['customer_processing_order']['email_content'];
