...
if( isset($email_templates['customer_new_account']) 
    ...
    && isset($email_templates['customer_new_account']['email_content']) 
    && !empty($email_templates['customer_new_account']['email_content']) ){
	echo $email_templates['customer_new_account']['email_content'];
